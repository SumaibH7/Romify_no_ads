package com.bluell.roomdecoration.interiordesign.ui.favorites.edit
...
import com.bluell.roomdecoration.interiordesign.databinding.FragmentEditFavoritesBinding
...
class EditFavoritesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getAllCreations("edit")
        initObservers()
    }

    private fun initObservers() {
        appDatabase.genericResponseDao()?.getAllFavoritesLive("edit")?.observe(viewLifecycleOwner) {
            if (it.isNotEmpty()) {
