...
import com.bluell.roomdecoration.interiordesign.databinding.FragmentInspireHistoryBinding
...
@AndroidEntryPoint
class InspireHistoryFragment : Fragment() {

    private var _binding:FragmentInspireHistoryBinding ?= null
    ...
    private val viewModel: InspireHistoryViewmodel by viewModels()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentInspireHistoryBinding.inflate(inflater,container,false)
    ...
    private fun initObservers() {
        appDatabase.genericResponseDao()?.getAllCreationsLive(0,Constants.INSPIRE_END_POINT)?.observe(viewLifecycleOwner) {
            if (it.isNotEmpty()) {
