package com.bluell.roomdecoration.interiordesign.ui.history.interior
...
import com.bluell.roomdecoration.interiordesign.databinding.FragmentInteriorHistoryBinding
...
@AndroidEntryPoint
class InteriorHistoryFragment : Fragment() {
    private var _binding: FragmentInteriorHistoryBinding? = null
    ...
    private val viewModel: InteriorHistoryViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentInteriorHistoryBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initObservers() {
        appDatabase.genericResponseDao()?.getAllCreationsLive(0, Constants.INTERIOR_END_POINT)
    ...
    private fun initMyCreations() {
        ...
        myCreationAdapter = arrayListMyCreations?.let {
            HistoryAdapter(it, object : MyInteriorClicks {
