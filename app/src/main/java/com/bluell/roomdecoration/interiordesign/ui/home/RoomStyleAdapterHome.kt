...
import com.bluell.roomdecoration.interiordesign.databinding.RoomStyleItemHomeBinding

class RoomStyleAdapterHome (private val roomTypes:ArrayList<RoomTypeModel>,
                            private var selectedItemPosition: Int,
                            private var roomTypeSelectionInterface: RoomTypeSelectionInterface
): RecyclerView.Adapter<RoomStyleAdapterHome.Viewholder>() {
    inner class Viewholder(val binding: RoomStyleItemHomeBinding): RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Viewholder {
        val binding = RoomStyleItemHomeBinding.inflate(LayoutInflater.from(parent.context),parent,false)
