package com.bluell.roomdecoration.interiordesign.ui.favorites.inspire
...
import com.bluell.roomdecoration.interiordesign.databinding.FragmentInspireFavoritesBinding
...
import com.bluell.roomdecoration.interiordesign.ui.favorites.GenerateFavoriteAdapter
...
@AndroidEntryPoint
class InspireFavoritesFragment : Fragment() {

    private var _binding: FragmentInspireFavoritesBinding? = null
    private val binding get() = _binding!!


    private var arrayListMyCreations: MutableList<genericResponseModel>? = mutableListOf()
    private var myCreationAdapter: GenerateFavoriteAdapter? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentInspireFavoritesBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getAllCreations("inspire")
        initObservers()
    }

    private fun initObservers() {
        appDatabase.genericResponseDao()?.getAllFavoritesLive("inspire")
    ...
    private fun initMyCreations() {
        ...
        myCreationAdapter = arrayListMyCreations?.let {
            GenerateFavoriteAdapter(it, object :
                MyInteriorClicks {
                ...
                override fun onItemClick(item: genericResponseModel?, position: Int) {
                    Bundle().apply {
                        ...
                        findNavController().navigate(R.id.fullScreenInspireFragment, this)
                    }
                }
            })
        }
