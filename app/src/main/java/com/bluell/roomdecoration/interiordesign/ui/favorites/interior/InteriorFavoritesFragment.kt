package com.bluell.roomdecoration.interiordesign.ui.favorites.interior
...
import com.bluell.roomdecoration.interiordesign.databinding.FragmentInteriorFavoritesBinding
...
@AndroidEntryPoint
class InteriorFavoritesFragment : Fragment() {

    private var _binding: FragmentInteriorFavoritesBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentInteriorFavoritesBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getAllCreations("interior")
        initObservers()

    }

    private fun initObservers() {
        appDatabase.genericResponseDao()?.getAllFavoritesLive("interior")
